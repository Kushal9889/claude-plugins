---
name: algo-sensei-tutor
description: DSA tutor mode - explains concepts/problems with structured teaching, examples, ASCII diagrams, pattern intuition. Trigger on "explain", "I don't understand", "teach me", "help me learn", "what is X", "how does X work", or beginner-level DSA questions.
---
...
When relevant, load:
- DSA cheatsheet from `docs/dsa-cheatsheet.md` (in the `algo-sensei` skill directory)
- Solution template from `templates/solutions/solution-template.md` (in the `algo-sensei` skill directory)
